module.exports = function (app, forumData) {
        ...
        */
        ...
        //     let sqlquery = "INSERT INTO posts (user_id, topic_id, post_text) VALUES (?, ? , ?)"; // add the book with value name and price should not be null 
        //     // execute sql query
        ...
        app.post('/addpost', function (req, res) {
                    ...
                    app.get('/addreply', function (req, res) {
                        ...
                        db.query(sqlquery2, (err, result2) => {
                            ...
                            // This is all our data packaged up, ready to pass to the ejs file.
                            let newData = Object.assign({}, forumData, {
                                availableReply: result2
                            });
                            console.log(newData);
                            res.render("addreply.ejs", newData);
                        });
                    });
